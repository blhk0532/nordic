...
/**
* @see \App\Http\Controllers\Api\RatsitQueueController::runPersoner
* @see app/Http/Controllers/Api/RatsitQueueController.php:21
* @route '/api/ratsit-queue/run-personer'
*/
...
runPersoner.definition = {
    methods: ["get","head"],
    url: '/api/ratsit-queue/run-personer',
...
/**
* @see \App\Http\Controllers\Api\RatsitQueueController::bulkUpdate
* @see app/Http/Controllers/Api/RatsitQueueController.php:64
* @route '/api/ratsit-queue/bulk-update'
*/
...
bulkUpdate.definition = {
    methods: ["post"],
    url: '/api/ratsit-queue/bulk-update',
...
/**
* @see \App\Http\Controllers\Api\RatsitQueueController::updateByPostNummer
* @see app/Http/Controllers/Api/RatsitQueueController.php:122
* @route '/api/ratsit-queue/update/{postNummer}'
*/
...
updateByPostNummer.definition = {
    methods: ["put"],
    url: '/api/ratsit-queue/update/{postNummer}',
...
const RatsitQueueController = { runPersoner, bulkUpdate, updateByPostNummer }

export default RatsitQueueController