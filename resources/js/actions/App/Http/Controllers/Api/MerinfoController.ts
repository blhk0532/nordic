...
* @see app/Http/Controllers/Api/MerinfoController.php:19
* @route '/api/merinfo'
*/
...
* @see app/Http/Controllers/Api/MerinfoController.php:49
* @route '/api/merinfo'
*/
...
* @see app/Http/Controllers/Api/MerinfoController.php:80
...
* @see app/Http/Controllers/Api/MerinfoController.php:90
* @route '/api/merinfo/{merinfo}'
*/
...
* @see app/Http/Controllers/Api/MerinfoController.php:123
* @route '/api/merinfo/{merinfo}'
*/
...
* @see app/Http/Controllers/Api/MerinfoController.php:134
