...
/**
* @see \App\Filament\Queue\Resources\RatsitPostorter\Pages\ListRatsitPostorter::__invoke
* @see app/Filament/Queue/Resources/RatsitPostorter/Pages/ListRatsitPostorter.php:7
* @route '/nds/queue/ratsit-postorter/ratsit-postorts'
*/
...
ListRatsitPostorter.definition = {
    methods: ["get","head"],
    url: '/nds/queue/ratsit-postorter/ratsit-postorts',
