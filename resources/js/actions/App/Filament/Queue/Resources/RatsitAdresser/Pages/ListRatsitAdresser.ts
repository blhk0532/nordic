...
/**
* @see \App\Filament\Queue\Resources\RatsitAdresser\Pages\ListRatsitAdresser::__invoke
* @see app/Filament/Queue/Resources/RatsitAdresser/Pages/ListRatsitAdresser.php:7
* @route '/nds/queue/ratsit-adresser/ratsit-adresses'
*/
...
ListRatsitAdresser.definition = {
    methods: ["get","head"],
    url: '/nds/queue/ratsit-adresser/ratsit-adresses',
