...
/**
* @see \App\Filament\Queue\Resources\RatsitData\Pages\EditRatsitData::__invoke
* @see app/Filament/Queue/Resources/RatsitData/Pages/EditRatsitData.php:7
* @route '/nds/queue/ratsit-data/{record}/edit'
*/
...
EditRatsitData.definition = {
    methods: ["get","head"],
    url: '/nds/queue/ratsit-data/{record}/edit',
