...
/**
* @see \App\Filament\Queue\Resources\PostNums\Pages\ViewPostNum::__invoke
* @see app/Filament/Queue/Resources/PostNums/Pages/ViewPostNum.php:7
* @route '/nds/queue/post-nums/{record}'
*/
...
ViewPostNum.definition = {
    methods: ["get","head"],
    url: '/nds/queue/post-nums/{record}',
