...
*/
const EditUser381b9f9805f31d63e3c8ff79d1e093ea = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, options),
    method: 'get',
})

EditUser381b9f9805f31d63e3c8ff79d1e093ea.definition = {
    methods: ["get","head"],
...
* @route '/admin/users/{record}/edit'
*/
EditUser381b9f9805f31d63e3c8ff79d1e093ea.url = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return EditUser381b9f9805f31d63e3c8ff79d1e093ea.definition.url
...
* @route '/admin/users/{record}/edit'
*/
EditUser381b9f9805f31d63e3c8ff79d1e093ea.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, options),
    method: 'get',
})
...
* @route '/admin/users/{record}/edit'
*/
EditUser381b9f9805f31d63e3c8ff79d1e093ea.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, options),
    method: 'head',
})
...
* @route '/admin/users/{record}/edit'
*/
const EditUser381b9f9805f31d63e3c8ff79d1e093eaForm = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, options),
    method: 'get',
})
...
* @route '/admin/users/{record}/edit'
*/
EditUser381b9f9805f31d63e3c8ff79d1e093eaForm.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, options),
    method: 'get',
})
...
* @route '/admin/users/{record}/edit'
*/
EditUser381b9f9805f31d63e3c8ff79d1e093eaForm.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUser381b9f9805f31d63e3c8ff79d1e093ea.url(args, {
...
EditUser381b9f9805f31d63e3c8ff79d1e093ea.form = EditUser381b9f9805f31d63e3c8ff79d1e093eaForm
/**
* @see \App\Filament\Admin\Resources\Users\Pages\EditUser::__invoke
* @see app/Filament/Admin/Resources/Users/Pages/EditUser.php:7
...
const EditUser = {
    '/admin/users/{record}/edit': EditUser381b9f9805f31d63e3c8ff79d1e093ea,
