...
* @route '/admin/teams/{record}'
*/
const ViewTeam80f79933cba728d3e0f7120e11223c85 = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, options),
    method: 'get',
})

ViewTeam80f79933cba728d3e0f7120e11223c85.definition = {
    methods: ["get","head"],
    url: '/admin/teams/{record}',
...
* @route '/admin/teams/{record}'
*/
ViewTeam80f79933cba728d3e0f7120e11223c85.url = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return ViewTeam80f79933cba728d3e0f7120e11223c85.definition.url
...
* @route '/admin/teams/{record}'
*/
ViewTeam80f79933cba728d3e0f7120e11223c85.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, options),
    method: 'get',
})
...
* @route '/admin/teams/{record}'
*/
ViewTeam80f79933cba728d3e0f7120e11223c85.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, options),
    method: 'head',
})
...
* @route '/admin/teams/{record}'
*/
const ViewTeam80f79933cba728d3e0f7120e11223c85Form = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, options),
    method: 'get',
})
...
* @route '/admin/teams/{record}'
*/
ViewTeam80f79933cba728d3e0f7120e11223c85Form.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, options),
    method: 'get',
})
...
* @route '/admin/teams/{record}'
*/
ViewTeam80f79933cba728d3e0f7120e11223c85Form.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ViewTeam80f79933cba728d3e0f7120e11223c85.url(args, {
...
ViewTeam80f79933cba728d3e0f7120e11223c85.form = ViewTeam80f79933cba728d3e0f7120e11223c85Form
/**
* @see \App\Filament\Admin\Resources\Teams\Pages\ViewTeam::__invoke
* @see app/Filament/Admin/Resources/Teams/Pages/ViewTeam.php:7
...
const ViewTeam = {
    '/admin/teams/{record}': ViewTeam80f79933cba728d3e0f7120e11223c85,
