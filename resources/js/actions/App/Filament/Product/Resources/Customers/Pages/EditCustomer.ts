...
/**
* @see \App\Filament\Product\Resources\Customers\Pages\EditCustomer::__invoke
* @see app/Filament/Product/Resources/Customers/Pages/EditCustomer.php:7
* @route '/nds/product/booking/customers/{record}/edit'
*/
...
EditCustomer.definition = {
    methods: ["get","head"],
    url: '/nds/product/booking/customers/{record}/edit',
