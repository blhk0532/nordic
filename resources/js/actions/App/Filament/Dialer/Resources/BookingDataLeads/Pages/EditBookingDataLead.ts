...
/**
* @see \App\Filament\Dialer\Resources\BookingDataLeads\Pages\EditBookingDataLead::__invoke
* @see app/Filament/Dialer/Resources/BookingDataLeads/Pages/EditBookingDataLead.php:7
* @route '/nds/dialer/booking-data-leads/{record}/edit'
*/
...
EditBookingDataLead.definition = {
    methods: ["get","head"],
    url: '/nds/dialer/booking-data-leads/{record}/edit',
