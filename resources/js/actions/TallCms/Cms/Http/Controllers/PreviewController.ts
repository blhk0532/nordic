...
/**
* @see \TallCms\Cms\Http\Controllers\PreviewController::tokenPreview
* @see plugins/tallcms/tallcms/packages/tallcms/cms/src/Http/Controllers/PreviewController.php:53
* @route '/preview/share/{token}'
*/
export const tokenPreview = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tokenPreview.url(args, options),
    method: 'get',
})

tokenPreview.definition = {
    methods: ["get","head"],
...
* @route '/preview/share/{token}'
*/
tokenPreview.url = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return tokenPreview.definition.url
...
* @route '/preview/share/{token}'
*/
tokenPreview.get = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tokenPreview.url(args, options),
    method: 'get',
})
...
* @route '/preview/share/{token}'
*/
tokenPreview.head = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: tokenPreview.url(args, options),
    method: 'head',
})
...
* @route '/preview/share/{token}'
*/
const tokenPreviewForm = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tokenPreview.url(args, options),
    method: 'get',
})
...
* @route '/preview/share/{token}'
*/
tokenPreviewForm.get = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tokenPreview.url(args, options),
    method: 'get',
})
...
* @route '/preview/share/{token}'
*/
tokenPreviewForm.head = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: tokenPreview.url(args, {
...
tokenPreview.form = tokenPreviewForm
...
const PreviewController = { tokenPreview, page, post }
