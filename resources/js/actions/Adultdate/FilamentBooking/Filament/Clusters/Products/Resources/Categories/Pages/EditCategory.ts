...
/**
* @see \Adultdate\FilamentBooking\Filament\Clusters\Products\Resources\Categories\Pages\EditCategory::__invoke
* @see plugins/adultdate/filament-booking/src/Filament/Clusters/Products/Resources/Categories/Pages/EditCategory.php:7
* @route '/nds/super/booking/products/categories/{record}/edit'
*/
...
EditCategory.definition = {
    methods: ["get","head"],
    url: '/nds/super/booking/products/categories/{record}/edit',
