...
*/
const ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, options),
    method: 'get',
})

ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.definition = {
    methods: ["get","head"],
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { record: args }
    }
    ...
    return ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.definition.url
            .replace('{record}', parsedArgs.record.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, options),
    method: 'head',
})
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
const ManageServiceProviderSchedules48528309901dea9e12d3503254756a6cForm = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6cForm.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/schedule'
*/
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6cForm.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c.form = ManageServiceProviderSchedules48528309901dea9e12d3503254756a6cForm
...
const ManageServiceProviderSchedules = {
    ...
    '/nds/user/booking/users/{record}/schedule': ManageServiceProviderSchedules48528309901dea9e12d3503254756a6c,
}
