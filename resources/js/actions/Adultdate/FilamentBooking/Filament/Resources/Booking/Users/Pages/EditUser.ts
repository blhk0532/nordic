...
*/
const EditUseraedf0ad0e9497bab5821ec7d42912bc4 = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, options),
    method: 'get',
})

EditUseraedf0ad0e9497bab5821ec7d42912bc4.definition = {
    methods: ["get","head"],
...
* @route '/nds/user/booking/users/{record}/edit'
*/
EditUseraedf0ad0e9497bab5821ec7d42912bc4.url = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { record: args }
    }
    ...
    return EditUseraedf0ad0e9497bab5821ec7d42912bc4.definition.url
            .replace('{record}', parsedArgs.record.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/nds/user/booking/users/{record}/edit'
*/
EditUseraedf0ad0e9497bab5821ec7d42912bc4.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/edit'
*/
EditUseraedf0ad0e9497bab5821ec7d42912bc4.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, options),
    method: 'head',
})
...
* @route '/nds/user/booking/users/{record}/edit'
*/
const EditUseraedf0ad0e9497bab5821ec7d42912bc4Form = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/edit'
*/
EditUseraedf0ad0e9497bab5821ec7d42912bc4Form.get = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, options),
    method: 'get',
})
...
* @route '/nds/user/booking/users/{record}/edit'
*/
EditUseraedf0ad0e9497bab5821ec7d42912bc4Form.head = (args: { record: string | number } | [record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: EditUseraedf0ad0e9497bab5821ec7d42912bc4.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
EditUseraedf0ad0e9497bab5821ec7d42912bc4.form = EditUseraedf0ad0e9497bab5821ec7d42912bc4Form
...
const EditUser = {
    ...
    '/nds/user/booking/users/{record}/edit': EditUseraedf0ad0e9497bab5821ec7d42912bc4,
}
