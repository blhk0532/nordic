...
/**
* @see \App\Filament\Dialer\Resources\BookingOutcallQueues\Pages\ViewBookingOutcallQueue::__invoke
* @see app/Filament/Dialer/Resources/BookingOutcallQueues/Pages/ViewBookingOutcallQueue.php:7
* @route '/nds/dialer/booking-outcall-queues/{record}'
*/
...
view.definition = {
    methods: ["get","head"],
    url: '/nds/dialer/booking-outcall-queues/{record}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Filament\Dialer\Resources\BookingOutcallQueues\Pages\EditBookingOutcallQueue::__invoke
* @see app/Filament/Dialer/Resources/BookingOutcallQueues/Pages/EditBookingOutcallQueue.php:7
* @route '/nds/dialer/booking-outcall-queues/{record}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/nds/dialer/booking-outcall-queues/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
