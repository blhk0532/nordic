...
/**
* @see \App\Filament\Queue\Resources\BookingOutcallQueues\Pages\ListBookingOutcallQueues::__invoke
* @see app/Filament/Queue/Resources/BookingOutcallQueues/Pages/ListBookingOutcallQueues.php:7
* @route '/nds/queue/booking-outcall-queues'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/nds/queue/booking-outcall-queues',
...
/**
* @see \App\Filament\Queue\Resources\BookingOutcallQueues\Pages\EditBookingOutcallQueue::__invoke
* @see app/Filament/Queue/Resources/BookingOutcallQueues/Pages/EditBookingOutcallQueue.php:7
* @route '/nds/queue/booking-outcall-queues/{record}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/nds/queue/booking-outcall-queues/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
