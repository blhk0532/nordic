...
/**
* @see \App\Filament\Data\Resources\PrivateData\Pages\EditPrivateData::__invoke
* @see app/Filament/Data/Resources/PrivateData/Pages/EditPrivateData.php:7
* @route '/nds/data/private-data/{record}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/nds/data/private-data/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
