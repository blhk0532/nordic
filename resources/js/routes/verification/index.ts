...
/**
* @see \App\Http\Controllers\Api\V1\AuthController::verify
* @see app/Http/Controllers/Api/V1/AuthController.php:73
* @route '/api/v1/email/verify/{id}/{hash}'
*/
export const verify = (args: { id: string | number, hash: string | number } | [id: string | number, hash: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/v1/email/verify/{id}/{hash}'
*/
verify.post = (args: { id: string | number, hash: string | number } | [id: string | number, hash: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: verify.url(args, options),
    method: 'post',
})
...
* @route '/api/v1/email/verify/{id}/{hash}'
*/
const verifyForm = (args: { id: string | number, hash: string | number } | [id: string | number, hash: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/v1/email/verify/{id}/{hash}'
*/
verifyForm.post = (args: { id: string | number, hash: string | number } | [id: string | number, hash: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: verify.url(args, options),
    method: 'post',
})
...
/**
* @see \App\Http\Controllers\UserEmailVerificationNotificationController::verify
...
/**
* @see \App\Http\Controllers\Api\V1\AuthController::send
