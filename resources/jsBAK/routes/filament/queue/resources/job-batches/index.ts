...
/**
* @see \App\Filament\Queue\Resources\JobBatches\Pages\ViewJobBatch::__invoke
* @see app/Filament/Queue/Resources/JobBatches/Pages/ViewJobBatch.php:7
* @route '/nds/queue/job-batches/{record}'
*/
...
view.definition = {
    methods: ["get","head"],
    url: '/nds/queue/job-batches/{record}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Filament\Queue\Resources\JobBatches\Pages\EditJobBatch::__invoke
* @see app/Filament/Queue/Resources/JobBatches/Pages/EditJobBatch.php:7
* @route '/nds/queue/job-batches/{record}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/nds/queue/job-batches/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
