...
/**
* @see \Adultdate\FilamentBooking\Filament\Clusters\Services\Resources\Clients\Pages\EditClient::__invoke
* @see plugins/adultdate/filament-booking/src/Filament/Clusters/Services/Resources/Clients/Pages/EditClient.php:7
* @route '/nds/super/services/clients/{record}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/nds/super/services/clients/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
