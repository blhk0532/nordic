...
/**
* @see \App\Http\Controllers\Api\RatsitForetagQueueController::index
* @see app/Http/Controllers/Api/RatsitForetagQueueController.php:15
* @route '/api/ratsit-foretag-queue'
*/
...
/**
* @see \App\Http\Controllers\Api\RatsitForetagQueueController::show
* @see app/Http/Controllers/Api/RatsitForetagQueueController.php:33
* @route '/api/ratsit-foretag-queue/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/ratsit-foretag-queue/{id}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Api\RatsitForetagQueueController::runForetag
* @see app/Http/Controllers/Api/RatsitForetagQueueController.php:40
* @route '/api/ratsit-foretag-queue/run-foretag'
*/
...
runForetag.definition = {
    methods: ["get","head"],
    url: '/api/ratsit-foretag-queue/run-foretag',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Api\RatsitForetagQueueController::bulkUpdate
* @see app/Http/Controllers/Api/RatsitForetagQueueController.php:74
* @route '/api/ratsit-foretag-queue/bulk-update'
*/
...
bulkUpdate.definition = {
    methods: ["post"],
    url: '/api/ratsit-foretag-queue/bulk-update',
...
/**
* @see \App\Http\Controllers\Api\RatsitForetagQueueController::updateByPostNummer
* @see app/Http/Controllers/Api/RatsitForetagQueueController.php:140
* @route '/api/ratsit-foretag-queue/update/{postNummer}'
*/
...
updateByPostNummer.definition = {
    methods: ["put"],
    url: '/api/ratsit-foretag-queue/update/{postNummer}',
...
const RatsitForetagQueueController = { index, show, runForetag, bulkUpdate, updateByPostNummer }

export default RatsitForetagQueueController