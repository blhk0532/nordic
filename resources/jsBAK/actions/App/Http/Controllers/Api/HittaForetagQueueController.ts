...
/**
* @see \App\Http\Controllers\Api\HittaForetagQueueController::index
* @see app/Http/Controllers/Api/HittaForetagQueueController.php:15
* @route '/api/hitta-foretag-queue'
*/
...
/**
* @see \App\Http\Controllers\Api\HittaForetagQueueController::show
* @see app/Http/Controllers/Api/HittaForetagQueueController.php:33
* @route '/api/hitta-foretag-queue/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/hitta-foretag-queue/{id}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Api\HittaForetagQueueController::runForetag
* @see app/Http/Controllers/Api/HittaForetagQueueController.php:40
* @route '/api/hitta-foretag-queue/run-foretag'
*/
...
runForetag.definition = {
    methods: ["get","head"],
    url: '/api/hitta-foretag-queue/run-foretag',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Api\HittaForetagQueueController::bulkUpdate
* @see app/Http/Controllers/Api/HittaForetagQueueController.php:74
* @route '/api/hitta-foretag-queue/bulk-update'
*/
...
bulkUpdate.definition = {
    methods: ["post"],
    url: '/api/hitta-foretag-queue/bulk-update',
...
/**
* @see \App\Http\Controllers\Api\HittaForetagQueueController::updateByPostNummer
* @see app/Http/Controllers/Api/HittaForetagQueueController.php:140
* @route '/api/hitta-foretag-queue/update/{postNummer}'
*/
...
updateByPostNummer.definition = {
    methods: ["put"],
    url: '/api/hitta-foretag-queue/update/{postNummer}',
...
const HittaForetagQueueController = { index, show, runForetag, bulkUpdate, updateByPostNummer }

export default HittaForetagQueueController