...
<x-dynamic-component :component="$fieldWrapperView" :field="$field">
    ...
    >
        <div
            ...
            x-data="(() => {
                const scriptSrc = @js(\Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('rich-editor', 'filament/forms'));
                    ...
                    init() {
                        const loadComponent = () => {
                            if (typeof richEditorFormComponent !== 'undefined') {
                                const component = richEditorFormComponent(componentConfig);
                                Object.keys(component).forEach(key => {
                                    this[key] = component[key];
                                });
                                if (typeof this.init === 'function' && this.init !== base.init) {
                                    this.init();
                                }
                            } else {
                                if (!document.querySelector('script[data-filament-rich-editor]')) {
                                    const script = document.createElement('script');
                                    script.src = scriptSrc;
                                    script.defer = true;
                                    script.dataset.filamentRichEditor = '1';
                ...
                return Object.assign(base, richEditorFormComponent(componentConfig));
            })()"
            x-bind:class="{
