                            ...
                            <div class="w-full h-full flex" wire:key="outcome-{{ $outcome->id }}">
                                ...
                                @else
                                    <button
                                        ...
                                        class="w-full h-full px-3 py-2 rounded-lg font-semibold text-sm shadow-sm hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
