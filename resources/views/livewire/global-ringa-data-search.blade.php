<div
    ...
    x-data="{ open: false }"
    x-show="open"
    x-on:open-modal.window="if ($event.detail.id === 'global-ringa-data-search') { open = true }"
    x-on:close-modal.window="if ($event.detail.id === 'global-ringa-data-search') { open = false }"
    style="display: none;"
...
<style>
    ...
    <div
        ...
        >
        <div class="h-full ringa-data-search-modal-widget" style="min-height: 100%; overflow: hidden;">
