...
.video-bg iframe {
  ...
  pointer-events: none; /* disables clicking the video */
    ...
    <body class="overflow-hidden bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex items-center lg:justify-center min-h-screen w-full flex-col" style="background-size: cover; background-position: center;">
  <div class="video-bg">
      <iframe
    ...
    allowfullscreen>
            ...
            @if (filament()->getLoginUrl())
                <nav class="flex items-center justify-end gap-4 hidden">
                    @auth
                        ...
                        >
                            {{ ucfirst(filament()->getCurrentPanel()?->getId() ?? 'Dashboard') }}
                        </a>
                    @else
                        <a
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] z-10 flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                   <svg  style="margin-left:-29px;margin-bottom:2px;" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 336" width="180" height="28" fill="currentColor">
	<style>
		.s0 { fill: #f9faf9 }
	</style>
	<g>
...
<div class="rocket-wrapper">
  ...
  <svg version="1.1" id="rocket" class="rocket" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="200px" height="200px" viewBox="0 0 360 360" enable-background="new 0 0 360 360" xml:space="preserve">
    ...
    <g class="circles">
      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="291.5" cy="265.5" r="37.5">
        <animate attributeType="xml" attributeName="r" values="27.5;27.5;37.5;27.5" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="267" cy="310" r="30">
        <animate attributeType="xml" attributeName="r" values="25;25;30;25" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="229.5" cy="324.5" r="20">
        <animate attributeType="xml" attributeName="r" values="15;15;20;15" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="335.5" cy="277.5" r="20">
        <animate attributeType="xml" attributeName="r" values="15;15;20;15" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="306.5" cy="224.5" r="22.5">
        <animate attributeType="xml" attributeName="r" values="11;11;22.5;11" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="330.5" cy="332.5" r="10">
        <animate attributeType="xml" attributeName="r" values="5;5;10;5" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="175.5" cy="291.5" r="10">
        <animate attributeType="xml" attributeName="r" values="5;5;10;5" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>

      <circle fill="#161615" stroke="#373736" stroke-width="3" stroke-miterlimit="10" cx="270.5" cy="177.5" r="10">
        <animate attributeType="xml" attributeName="r" values="5;5;10;5" keyTimes="0;0.4;0.6;1" dur="25s" repeatCount="indefinite" />
      </circle>
    </g>
  </svg>
...
let y = 0;
let scale = 1;
let animationPhase = 0; // 0: pause, 1: animate
let phaseTimer = 0;
...
function animate() {
  ...
  if (animationPhase === 1) {
    ...
    scale += (Math.random() - 0.5) * 0.001;
    scale = Math.max(0.99, Math.min(1.01, scale));

    // Occasional subtle jolts sideways
  ...
  rocket.style.transform = `translate(${x}px, ${y}px) rotate(${angle}deg) scale(${scale})`;
...
animate();
                    ...
                    <div class="bg-[#010101] dark:bg-[#010101] absolute inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"></div>
                </div>
            </main>
        </div>
