...
use App\Filament\Clients\Pages\ClientsDashboard;
...
final class ClientsPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('clients')
            ->path('nds/clients')
            ->viteTheme('resources/css/filament/clients/theme.css')
            ->colors([
                'primary' => Color::Gray,
            ])
            ->spa()
