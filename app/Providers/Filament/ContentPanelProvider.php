...
use App\Filament\Content\Pages\ContentDashboard;
...
final class ContentPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('content')
            ->path('nds/content')
            ->viteTheme('resources/css/filament/content/theme.css')
            ->colors([
                'primary' => Color::Gray,
            ])
            ->spa()
