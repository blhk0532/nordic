...
class PluginsPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('plugins')
            ->path('nds/plugins')
            ->viteTheme('resources/css/filament/plugins/theme.css')
            ->colors([
                'primary' => Color::Gray,
            ])
            ->spa()
         // ->profile()
            ...
            ->discoverResources(in: app_path('Filament/Plugins/Resources'), for: 'App\Filament\Plugins\Resources')
            ->discoverPages(in: app_path('Filament/Plugins/Pages'), for: 'App\Filament\Plugins\Pages')
            ->discoverResources(in: app_path('Filament/Plugins/Resources'), for: 'App\Filament\Plugins\Resources')
            ->pages([
                PluginsDashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Plugins/Widgets'), for: 'App\Filament\Plugins\Widgets')
            ->widgets([
                //    AccountWidget::class,
