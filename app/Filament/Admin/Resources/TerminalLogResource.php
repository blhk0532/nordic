...
class TerminalLogResource extends BaseTerminalLogResource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\TerminalLogResource\Pages\ListTerminalLogs::route('/'),
            'view' => \App\Filament\Admin\Resources\TerminalLogResource\Pages\ViewTerminalLog::route('/{record}'),
        ];
    }
}
