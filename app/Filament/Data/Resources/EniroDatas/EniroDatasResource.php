...
namespace App\Filament\Data\Resources\EniroDatas;

use App\Filament\Data\Resources\EniroDatas\Pages\CreateEniroData;
use App\Filament\Data\Resources\EniroDatas\Pages\EditEniroData;
use App\Filament\Data\Resources\EniroDatas\Pages\ListEniroDatas;
...
class EniroDatasResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'EniroData';

    protected static ?string $modelLabel = 'EniroData';

    protected static ?string $pluralModelLabel = 'EniroData';
    ...
    protected static ?string $slug = 'databaser/eniro-data';
    ...
    {
        return [
            'index' => ListEniroDatas::route('/'),
            'create' => CreateEniroData::route('/create'),
