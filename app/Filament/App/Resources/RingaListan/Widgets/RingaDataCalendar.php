...
final class RingaDataCalendar extends Widget implements HasCalendar
{
    ...
    public function getHeading(): string|Htmlable
    {
        ...
        logger()->info('RingaListan calendar getHeading', ['selectedTechnician' => $this->selectedTechnician, 'normalized' => $normalized]);
    ...
    public function onRecordSelected(int $recordId): void
    {
        ...
        logger()->info('RingaListan calendar selected technician', [
            'recordId' => $recordId,
    ...
    public function mount(): void
    {
        ...
        logger()->info('RingaListan calendar mount', [
