...
use App\Filament\App\Resources\RingaListan\Schemas\RingaDataInfolistPrimary;
...
class RingaDataInfolistPrimaryWidget extends Widget implements HasActions, HasSchemas
{
    ...
    protected string $view = 'filament.app.resources.ringa-data.widgets.ringa-data-infolist-primary-widget';
