...
class MultiCalendar1 extends Widget implements HasCalendar
{
    ...
    public $selectedTechnician1 = 'all';
    ...
    {
        return new HtmlString(view('filament.widgets.multi-calendar1-header', [
            'calendars' => \App\Models\BookingCalendar::all()->pluck('name', 'id'),
            'selectedTechnician1' => $this->selectedTechnician1,
        ])->render());
    }

    public function updatedSelectedTechnician1(): void
    {
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $this->selectedTechnician1;
    ...
    {
        $this->selectedTechnician1 = $this->pageFilters['booking_calendars_1'] ?? null;
        $this->refreshRecords();
    }
    ...
    public function mount(): void
    {
        ...
        $this->selectedTechnician1 = $calendarIds->get(0) ?? 'all';
