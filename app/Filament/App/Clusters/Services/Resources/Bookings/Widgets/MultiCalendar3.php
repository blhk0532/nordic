...
class MultiCalendar3 extends Widget implements HasCalendar
{
    ...
    protected string $filterKey = 'booking_calendars_3';

    public function getHeading(): string|Htmlable
    {
        return new HtmlString(view('filament.widgets.multi-calendar3-header', [
            'calendars' => \App\Models\BookingCalendar::all()->pluck('name', 'id'),
            'selectedTechnician3' => $this->selectedTechnician3,
        ])->render());
    }

    public function updatedSelectedTechnician3(): void
    {
    ...
    {
        $this->selectedTechnician3 = $this->pageFilters['booking_calendars_3'] ?? 'all';
        $this->refreshRecords();
    }
    ...
    public function mount(): void
    {
        ...
        $this->selectedTechnician3 = $calendarIds->get(2) ?? 'all';
