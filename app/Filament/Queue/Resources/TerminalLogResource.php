...
namespace App\Filament\Queue\Resources;
...
class TerminalLogResource extends BaseTerminalLogResource
{
    ...
    {
        return [
            'index' => \App\Filament\Queue\Resources\TerminalLogResource\Pages\ListTerminalLogs::route('/'),
            'view' => \App\Filament\Queue\Resources\TerminalLogResource\Pages\ViewTerminalLog::route('/{record}'),
        ];
    }
}
