...
class MultiCalendarX5 extends Widget implements HasCalendar, HasSchemas
{
    ...
    /**
     * Selected technician id from page filters (nullable).
     */
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $filters['booking_calendars_5'] ?? null;
    ...
    {
        $this->selectedTechnician = isset($this->pageFilters['booking_calendars_5']) ? (int) $this->pageFilters['booking_calendars_5'] : null;
        $this->refreshRecords();
    }
    ...
    {
        return 'BK-'.now()->format('Ymd').'-'.Str::upper(Str::random(5));
    }
    ...
    protected function getSelectedCalendarId(): ?int
    {
        ...
        $value = $filters['booking_calendars_5'] ?? null;
