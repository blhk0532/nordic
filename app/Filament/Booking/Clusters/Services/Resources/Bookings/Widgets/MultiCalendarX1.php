...
class MultiCalendarX1 extends Widget implements HasCalendar, HasSchemas
{
    ...
    {
        $this->selectedTechnician = isset($this->pageFilters['booking_calendars_1']) && is_numeric($this->pageFilters['booking_calendars_1']) ? (int) $this->pageFilters['booking_calendars_1'] : null;
        $this->refreshRecords();
    }
