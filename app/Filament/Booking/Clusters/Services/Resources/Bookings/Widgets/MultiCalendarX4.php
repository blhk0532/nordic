...
class MultiCalendarX4 extends Widget implements HasCalendar, HasSchemas
{
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $filters['booking_calendars_4'] ?? null;
    ...
    {
        $this->selectedTechnician = isset($this->pageFilters['booking_calendars_4']) ? (int) $this->pageFilters['booking_calendars_4'] : null;
        $this->refreshRecords();
    }
    ...
    {
        return 'BK-'.now()->format('Ymd').'-'.Str::upper(Str::random(4));
    }
    ...
    protected function getSelectedCalendarId(): ?int
    {
        ...
        $value = $filters['booking_calendars_4'] ?? null;
