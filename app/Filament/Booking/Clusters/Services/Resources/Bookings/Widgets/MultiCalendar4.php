...
class MultiCalendar4 extends Widget implements HasCalendar, HasSchemas
{
    ...
    public $selectedTechnician4 = 'all';
    ...
    {
        return new HtmlString(view('filament.widgets.multi-calendar4-header', [
            'calendars' => \App\Models\BookingCalendar::all()->pluck('name', 'id'),
            'selectedTechnician4' => $this->selectedTechnician4,
        ])->render());
    }

    public function updatedSelectedTechnician4(): void
    {
    ...
    public function mount(): void
    {
        ...
        $this->selectedTechnician4 = $calendarIds->get(3) ?? 'all';
