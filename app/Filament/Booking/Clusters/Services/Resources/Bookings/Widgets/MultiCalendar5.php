...
class MultiCalendar5 extends Widget implements HasCalendar, HasSchemas
{
    ...
    public $selectedTechnician5 = 'all';
    ...
    protected string $filterKey = 'booking_calendars_5';

    public function getHeading(): string|Htmlable
    {
        return new HtmlString(view('filament.widgets.multi-calendar5-header', [
            'calendars' => \App\Models\BookingCalendar::all()->pluck('name', 'id'),
            'selectedTechnician5' => $this->selectedTechnician5,
        ])->render());
    }

    public function updatedSelectedTechnician5(): void
    {
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $this->selectedTechnician5;
    ...
    {
        $this->selectedTechnician5 = $this->pageFilters['booking_calendars_5'] ?? 'all';
        $this->refreshRecords();
    }
    ...
    public function mount(): void
    {
        ...
        $this->selectedTechnician5 = $calendarIds->get(4) ?? 'all';
