...
class MultiCalendarX6 extends Widget implements HasCalendar, HasSchemas
{
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $filters['booking_calendars_6'] ?? null;
    ...
    {
        $this->selectedTechnician = isset($this->pageFilters['booking_calendars_6']) ? (int) $this->pageFilters['booking_calendars_6'] : null;
        $this->refreshRecords();
    }
    ...
    protected function getSelectedCalendarId(): ?int
    {
        ...
        $value = $filters['booking_calendars_6'] ?? null;
