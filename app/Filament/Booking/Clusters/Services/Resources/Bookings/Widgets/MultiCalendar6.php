...
class MultiCalendar6 extends Widget implements HasCalendar, HasSchemas
{
    ...
    public $selectedTechnician6 = 'all';
    ...
    protected string $filterKey = 'booking_calendars_2';

    public function getHeading(): string|Htmlable
    {
        return new HtmlString(view('filament.widgets.multi-calendar6-header', [
            'calendars' => \App\Models\BookingCalendar::all()->pluck('name', 'id'),
            'selectedTechnician6' => $this->selectedTechnician6,
        ])->render());
    }

    public function updatedSelectedTechnician6(): void
    {
    ...
    public function getEvents(FetchInfo $info): Collection|array|Builder
    {
        ...
        $selectedCalendarId = $this->selectedTechnician6;
    ...
    {
        $this->selectedTechnician6 = $this->pageFilters['booking_calendars_6'] ?? $this->selectedTechnician6;
        $this->refreshRecords();
    }
    ...
    {
        $calendars = \App\Models\BookingCalendar::all()->pluck('name', 'id');
        $calendarIds = $calendars->keys();
        $this->selectedTechnician6 = $calendarIds->get(5) ?? 'all';
