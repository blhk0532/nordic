...
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX1;
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX2;
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX3;
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX4;
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX5;
use App\Filament\Booking\Clusters\Services\Resources\Bookings\Widgets\MultiCalendarX6;
...
class BookingCalendersX6 extends BaseDashboard
{
    use HasFiltersForm;
    ...
    protected static string $routePath = 'nds-kalender-x6';
    ...
    {
        return ''.Str::ucfirst('NDS Kalender x6') ?? 'NDS Kalender x6';
    }
            ...
            ->components([
                Section::make()
                    ->schema([
                        ...
                        Select::make('booking_calendars_5')
                            ->options($calendarOptions)
                            ->label('#5 ◴ Tekniker')
                            ->placeholder('Select Tekniker for Calendar 5')
                            ->searchable()
                            ->live()
                            ->default($calendarIds[2] ?? null)
                            ->afterStateUpdated(function ($state) {
                        ...
                        Select::make('booking_calendars_6')
                            ->options($calendarOptions)
                            ->label('#6 ◴ Tekniker')
                            ->placeholder('Select Tekniker for Calendar 6')
                            ->searchable()
                            ->live()
                            ->default($calendarIds[2] ?? null)
                            ->afterStateUpdated(function ($state) {
