...
return [
    ...
    */
    'table_names' => [
        FilamentFlexibleContentBlockPagesConfig::TYPE_PAGE => 'content_block_pages',
        FilamentFlexibleContentBlockPagesConfig::TYPE_AUTHOR => 'users',
        FilamentFlexibleContentBlockPagesConfig::TYPE_SETTINGS => 'content_block_settings',
        FilamentFlexibleContentBlockPagesConfig::TYPE_REDIRECT => 'content_block_redirects',
        FilamentFlexibleContentBlockPagesConfig::TYPE_TAG => 'content_block_tags',
        FilamentFlexibleContentBlockPagesConfig::TYPE_TAGGABLE => 'content_block_taggables',
        FilamentFlexibleContentBlockPagesConfig::TYPE_TAG_TYPE => 'content_block_tag_types',
        FilamentFlexibleContentBlockPagesConfig::TYPE_MENU => 'content_block_menus',
        FilamentFlexibleContentBlockPagesConfig::TYPE_MENU_ITEM => 'content_block_menu_items',
    ],
