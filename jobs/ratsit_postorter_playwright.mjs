            ...
            try {
                ...
                if (existingId) {
                    await connection.execute(
                        'UPDATE ratsit_postorter SET personer_count = ?, personer_link = ? WHERE id = ?',
                        [
                    ...
                    await connection.execute(
                        'INSERT INTO ratsit_postorter (post_ort, post_nummer, personer_count, personer_link) VALUES (?, ?, ?, ?)',
                        [
                            postort.post_ort,
                            postort.post_nummer,
                            postort.post_nummer_count,
