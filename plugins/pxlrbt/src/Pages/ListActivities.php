...
abstract class ListActivities extends Page implements HasForms
{
    ...
    final public function mount($record)
    {
    ...
    final public function getActivities()
    {
    ...
    final public function getPaginationMode(): PaginationMode
    {
        return PaginationMode::Default;
    }

    final public function getFieldLabel(string $name): string
    {
    ...
    final public function canRestoreActivity(): bool
    {
        return static::getResource()::canRestore($this->record);
    }

    final public function restoreActivity(int|string $key)
    {
