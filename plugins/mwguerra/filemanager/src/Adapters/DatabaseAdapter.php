...
class DatabaseAdapter implements FileManagerAdapterInterface
{
     ...
     */
    private function wrap(FileSystemItemInterface $model): DatabaseItem
    {
     ...
     */
    private function wrapCollection($models): Collection
    {
     ...
     * Find a model by ID.
     */
    private function find(int $id): ?FileSystemItemInterface
    {
     ...
     */
    private function getModelFromIdentifier(string $identifier): ?FileSystemItemInterface
    {
     ...
     */
    private function pathToFolderId(?string $path): ?int
    {
     ...
     */
    private function resolvePathToId(string $path): ?int
    {
