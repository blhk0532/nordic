...
class FileManagerPlugin implements Plugin
{
    ...
    private bool $panelSidebarEnabled = false;

    private string $panelSidebarRenderHook = PanelsRenderHook::SIDEBAR_NAV_START;

    private ?array $panelSidebarScopes = null;

    private ?string $panelSidebarRootLabel = null;

    private ?string $panelSidebarHeading = null;

    // =========================================================================
    // File Manager Page Configuration
    // =========================================================================

    private bool $fileManagerEnabled = true;

    private bool $fileManagerPageSidebarEnabled = true;

    private ?string $fileManagerNavigationIcon = null;

    private ?string $fileManagerNavigationLabel = null;

    private ?int $fileManagerNavigationSort = null;

    private ?string $fileManagerNavigationGroup = null;

    private ?string $fileManagerSidebarRootLabel = null;

    private ?string $fileManagerSidebarHeading = null;

    // =========================================================================
    // File System Page Configuration
    // =========================================================================

    private bool $fileSystemEnabled = true;

    private bool $fileSystemPageSidebarEnabled = true;

    private ?string $fileSystemNavigationIcon = null;

    private ?string $fileSystemNavigationLabel = null;

    private ?int $fileSystemNavigationSort = null;

    private ?string $fileSystemNavigationGroup = null;

    private ?string $fileSystemSidebarRootLabel = null;

    private ?string $fileSystemSidebarHeading = null;

    // =========================================================================
    // Schema Example Page Configuration
    // =========================================================================

    private bool $schemaExampleEnabled = true;

    // =========================================================================
    // Embed Config Test Page Configuration (for E2E testing)
    // =========================================================================

    private bool $embedConfigTestEnabled = true;
     ...
     */
    private function registerPanelSidebarRenderHook(): void
    {
