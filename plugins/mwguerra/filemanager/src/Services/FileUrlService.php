...
class FileUrlService
{
     ...
     */
    private function generateSignedStreamUrl(
        string $disk,
        string $path,
        string $mode,
        ?string $identifier,
     ...
     */
    private function supportsTemporaryUrls(string $driver, array $diskConfig): bool
    {
     ...
     */
    private function isPubliclyAccessible(string $disk, string $driver, array $diskConfig): bool
    {
