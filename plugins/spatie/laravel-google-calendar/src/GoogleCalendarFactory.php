...
class GoogleCalendarFactory
{
    ...
    private static function createServiceAccountClient(array $authProfile): Google_Client
    {
    ...
    private static function createOAuthClient(array $authProfile): Google_Client
    {
        $client = new Google_Client;
    ...
    private static function createCalendarClient(Google_Service_Calendar $service, string $calendarId): GoogleCalendar
    {
