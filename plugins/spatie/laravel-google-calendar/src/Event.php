...
class Event
{
    ...
    public static function create(array $properties, ?string $calendarId = null, $optParams = [])
    {
        ...
        $event->calendarId = self::getGoogleCalendar($calendarId)->getCalendarId();
    ...
    public static function quickCreate(string $text)
    {
        ...
        $event->calendarId = self::getGoogleCalendar()->getCalendarId();
    ...
    private static function getGoogleCalendar(?string $calendarId = null): GoogleCalendar
    {
    ...
    private function setDateProperty(string $name, CarbonInterface $date)
    {
    ...
    private function setSourceProperty(array $value)
    {
