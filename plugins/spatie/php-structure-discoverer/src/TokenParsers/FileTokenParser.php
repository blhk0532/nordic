...
class FileTokenParser
{
    public function __construct(
        private UseTokenParser $useResolver = new UseTokenParser,
        private NamespaceTokenParser $namespaceResolver = new NamespaceTokenParser,
        private DiscoveredDataTokenParser $discoveredDataResolver = new DiscoveredDataTokenParser,
        private AttributeTokenParser $attributeResolver = new AttributeTokenParser,
    ) {}
