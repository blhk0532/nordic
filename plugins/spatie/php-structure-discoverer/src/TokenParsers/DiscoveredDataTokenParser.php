...
class DiscoveredDataTokenParser
{
    public function __construct(
        private ReferenceTokenParser $referenceTokenResolver = new ReferenceTokenParser,
        private ReferenceListTokenParser $classListResolver = new ReferenceListTokenParser,
        private DiscoveredEnumTokenParser $discoveredEnumResolver = new DiscoveredEnumTokenParser,
        private DiscoveredClassTokenParser $discoveredClassResolver = new DiscoveredClassTokenParser,
        private StructureHeadTokenParser $structureHeadResolver = new StructureHeadTokenParser,
    ) {}
