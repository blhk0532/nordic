...
class StructuresResolver
{
    public function __construct(
        private DiscoverWorker $discoverWorker = new SynchronousDiscoverWorker,
        private StructureChainResolver $structureChainResolver = new StructureChainResolver
    ) {}
    ...
    private function discover(DiscoverProfileConfig $config): array
    {
