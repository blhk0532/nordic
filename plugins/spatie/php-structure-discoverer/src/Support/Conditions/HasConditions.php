...
interface HasConditions
{
    ...
    public function custom(DiscoverCondition|self|Closure ...$conditions): self;

    public function any(DiscoverCondition|self ...$conditions): self;

    public function exact(DiscoverCondition|self ...$conditions): self;
}
