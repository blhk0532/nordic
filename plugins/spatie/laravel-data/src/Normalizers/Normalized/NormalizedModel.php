...
class NormalizedModel implements Normalized
{
    ...
    private ReflectionProperty $attributesProperty;

    private ReflectionProperty $castsProperty;
    ...
    private function fetchNewProperty(string $name, DataProperty $dataProperty): mixed
    {
    ...
    private function hasModelAttribute(string $name): bool
    {
