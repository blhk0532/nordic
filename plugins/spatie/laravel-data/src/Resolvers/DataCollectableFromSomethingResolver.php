...
class DataCollectableFromSomethingResolver
{
    public function __construct(
        ...
        private DataFromSomethingResolver $dataFromSomethingResolver,
        private DataReturnTypeFactory $dataReturnTypeFactory,
    ) {}
    ...
    private function createFromCustomCreationMethod(
        string $dataClass,
        CreationContext $creationContext,
        mixed $items,
        ?string $into,
    ...
    private function normalizeToArray(
    ...
    private function normalizeToPaginator(
    ...
    private function normalizeToCursorPaginator(
        array|Paginator|AbstractPaginator|CursorPaginator|AbstractCursorPaginator $items,
        CollectableMetaData $collectableMetaData,
    ...
    private function itemsToDataClosure(
        string $dataClass,
        CreationContext $creationContext
    ): Closure {
