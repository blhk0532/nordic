...
class DataValidationRulesResolver
{
    public function __construct(
        ...
        private RuleNormalizer $ruleAttributesResolver,
        private RuleDenormalizer $ruleDenormalizer,
        private DataMorphClassResolver $dataMorphClassResolver,
    ) {}
    ...
    private function shouldSkipPropertyValidation(
    ...
    private function resolveDataSpecificRules(
        DataProperty $dataProperty,
        array $fullPayload,
        ValidationPath $path,
        ValidationPath $propertyPath,
    ...
    private function resolveDataObjectSpecificRules(
        DataProperty $dataProperty,
        array $fullPayload,
        ValidationPath $path,
        ValidationPath $propertyPath,
    ...
    private function resolveDataCollectionSpecificRules(
        DataProperty $dataProperty,
        array $fullPayload,
        ValidationPath $path,
        ValidationPath $propertyPath,
    ...
    private function resolveStaticCollectionRules(
    ...
    private function resolveDynamicCollectionRules(
        DataProperty $dataProperty,
        array $fullPayload,
        ValidationPath $propertyPath,
        DataRules $dataRules,
    ...
    private function resolveToplevelRules(
        DataProperty $dataProperty,
        array $fullPayload,
        ValidationPath $path,
        ValidationPath $propertyPath,
    ...
    private function inferRulesForDataProperty(
