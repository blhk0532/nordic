...
class VisibleDataFieldsResolver
{
     ...
     */
    private function performExcept(
        array &$fields,
        TransformationContext $transformationContext,
        DataClass $dataClass,
    ): void {
     ...
     * @param  array<string, TransformationContext|null>  $fields
     */
    private function resolveIncludedFields(
        array &$fields,
        TransformationContext $transformationContext,
        DataClass $dataClass
    ): array {
     ...
     * @param  array<string, TransformationContext|null>  $fields
     */
    private function resolveExcludedFields(
        array &$fields,
        TransformationContext $transformationContext,
        DataClass $dataClass
    ): array {
    ...
    private function handleNonExistingNestedField(
