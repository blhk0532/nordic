...
class CollectionAnnotationReader
{
    ...
    private function isIterable(ReflectionClass $class): bool
    {
     ...
     */
    private function getCollectionReturnType(ReflectionClass $class): ?array
    {
    ...
    private function resolve(string $type): ?string
    {
        ...
        return $type ? mb_ltrim($type, '\\') : null;
    }
}
