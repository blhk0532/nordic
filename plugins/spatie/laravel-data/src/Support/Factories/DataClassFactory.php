...
class DataClassFactory
{
    public function __construct(
        private DataPropertyFactory $propertyFactory,
        private DataMethodFactory $methodFactory,
    ...
    public function build(ReflectionClass $reflectionClass): DataClass
    {
        ...
        return new DataClass(
            ...
            transformationFields: self::resolveTransformationFields($properties)
        );
    }
