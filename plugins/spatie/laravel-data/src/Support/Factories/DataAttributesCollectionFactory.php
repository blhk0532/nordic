...
class DataAttributesCollectionFactory
{
    public static function buildFromReflectionClass(ReflectionClass $reflectionClass): DataAttributesCollection
    {
        ...
        while ($parent = self::findParentReflectionClass($reflectionClass)) {
        ...
        return new DataAttributesCollection(
            self::mapAttributesIntoGroups(array_merge(...$attributeGroups))
        );
    }
    ...
    {
        return new DataAttributesCollection(
            self::mapAttributesIntoGroups($reflectionProperty->getAttributes())
        );
    }

    private static function findParentReflectionClass(ReflectionClass $reflectionClass): ?ReflectionClass
    {
     ...
     */
    private static function mapAttributesIntoGroups(array $reflectionAttributes): array
    {
        $attributes = [];
