...
class DataTypeFactory
{
    public function __construct(
        private DataIterableAnnotationReader $iterableAnnotationReader,
        private CollectionAnnotationReader $collectionAnnotationReader,
    ) {}
     ...
     * }
     */
    private function inferPropertiesForNoneType(): array
    {
        $type = new NamedType(
            name: 'mixed',
            builtIn: true,
     ...
     *  }
     */
    private function inferPropertiesForSingleType(
     ...
     *  }
     */
    private function inferPropertiesForNamedType(
        string $name,
        bool $builtIn,
        ReflectionClass|string $class,
        ReflectionMethod|ReflectionProperty|ReflectionParameter|string $typeable,
     ...
     *  }
     */
    private function inferPropertiesForCombinationType(
