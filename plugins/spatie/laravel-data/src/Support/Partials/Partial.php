...
class Partial implements Stringable
{
    ...
    public static function fromSerializedArray(array $partial): self
    {
        return new self(
    ...
    private static function resolveSegmentsFromPath(string $path): array
    {
    ...
    private function getCurrentSegment(): ?PartialSegment
    {
