...
class Filesystem
{
    private array $customRemoteHeaders = [];
    ...
    private function shouldCopyFileOnDisk(RemoteFile $file, Media $media, string $diskDriverName): bool
    {
    ...
    private function copyFileOnDisk(string $file, string $destination, string $disk): void
    {
        $this->filesystem->disk($disk)
            ->copy($file, $destination);
    }

    private function streamFileToDisk($stream, string $destination, string $disk, array $headers): void
    {
        $this->filesystem->disk($disk)
    ...
    private function renameMediaFile(Media $media): void
    {
    ...
    private function renameConversionFiles(Media $media): void
    {
