...
abstract class BaseUrlGenerator implements UrlGenerator
{
     ...
     * @return $this
     */
    final public function setMedia(Media $media): UrlGenerator
    {
        $this->media = $media;
     ...
     * @return $this
     */
    final public function setConversion(Conversion $conversion): UrlGenerator
    {
     ...
     * @return $this
     */
    final public function setPathGenerator(PathGenerator $pathGenerator): UrlGenerator
    {
    ...
    final public function getPathRelativeToRoot(): string
    {
    ...
    final public function versionUrl(string $path = ''): string
    {
