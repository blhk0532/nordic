 ...
 * @property ?MediaCollections\MediaCollection $mediaCollections
 */
interface HasMedia
{
    ...
    public function clearMediaCollectionExcept(string $collectionName = 'default', array|Collection $excludedMedia = []): self;
