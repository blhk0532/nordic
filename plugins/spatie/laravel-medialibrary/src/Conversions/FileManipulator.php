...
class FileManipulator
{
     ...
     * @return $this
     */
    private function dispatchQueuedConversions(
        Media $media,
        ConversionCollection $conversions,
        bool $onlyMissing = false
    ): self {
     ...
     * @return $this
     */
    private function generateResponsiveImages(Media $media, bool $withResponsiveImages): self
    {
    ...
    private function canConvertMedia(Media $media): bool
    {
