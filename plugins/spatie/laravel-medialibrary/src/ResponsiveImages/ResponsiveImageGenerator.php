...
{
    private const DEFAULT_CONVERSION_QUALITY = 90;
    ...
    public function __construct(
        ...
        private TinyPlaceholderGenerator $tinyPlaceholderGenerator
    ) {
    ...
    private function appendToFileName(string $filePath, string $suffix, ?string $extensionFilePath = null): string
    {
    ...
    private function guardAgainstInvalidTinyPlaceHolder(string $tinyPlaceholderPath): void
    {
    ...
    private function cleanResponsiveImages(Media $media, string $conversionName = 'media_library_original'): Media
    {
    ...
    private function addPropertiesToFileName(string $fileName, string $conversionName, int $width, int $height, string $extension): string
    {
