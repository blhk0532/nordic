...
abstract class PackageServiceProvider extends ServiceProvider
{
    ...
    final public function registeringPackage() {}
    ...
    final public function packageRegistered() {}
    ...
    final public function bootingPackage() {}

    final public function packageBooted() {}

    final public function packageView(?string $namespace): ?string
    {
