...
class RoleResource extends Resource
{
    ...
    {
        return self::getEssentialsPlugin()?->getNavigationGroup();
    }

    public static function getNavigationIcon(): ?string
    {
        return self::getEssentialsPlugin()?->getNavigationIcon();
    }

    public static function getNavigationSort(): ?int
    {
        return self::getEssentialsPlugin()?->getNavigationSort();
    }

    public static function getNavigationBadge(): ?string
    {
        return self::getEssentialsPlugin()?->getNavigationBadge();
    }
