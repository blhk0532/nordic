...
final class FilamentExceptions
{
    ...
    private static ?Closure $shouldRecordCallback = null;
    ...
    public static function report(Throwable $throwable): void
    {
        try {
            ...
            if (self::$shouldRecordCallback instanceof Closure && ! call_user_func(self::$shouldRecordCallback, $throwable)) {
                return;
            }

            if (! self::shouldCapture($throwable)) {
                return;
            }
    ...
    {
        self::$shouldRecordCallback = $callback;
    }
