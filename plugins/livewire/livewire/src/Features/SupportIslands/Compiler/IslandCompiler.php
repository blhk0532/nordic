...
final class IslandCompiler
{
    ...
    private function generateScopeProviderCode(string $expression): string
    {
...
PHP;
    ...
    private function stripBladeComments(string $contents): array
    {
        $comments = [];
    ...
    private function restoreBladeComments(string $contents, array $comments): string
    {
