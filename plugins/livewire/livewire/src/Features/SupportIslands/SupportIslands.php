...
final class SupportIslands extends ComponentHook
{
    ...
    {
        self::registerInlineIslandPrecompiler();
        self::registerIslandDirective();
    }
    ...
    public static function registerInlineIslandPrecompiler()
    {
        Blade::prepareStringsForCompilationUsing(function ($content) {
            ...
            if (! str_contains($content, '@endisland')) {
                return $content;
            }
    ...
    public function call($method, $params, $returnEarly, $metadata, $componentContext)
    {
        ...
        return function (...$params) use ($island, $mount, $metadata) {
            ...
            if ($this->storeGet('skipIslandsRender', false)) {
                return;
            }
