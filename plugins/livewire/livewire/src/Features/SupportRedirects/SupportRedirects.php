...
final class SupportRedirects extends ComponentHook
{
    ...
    public function boot()
    {
        ...
        self::$redirectorCacheStack[] = app('redirect');
    ...
    public function dehydrate($context)
    {
        ...
        if (! $context->isMounting()) {
            self::$atLeastOneMountedComponentHasRedirected = true;
        }
    }
}
