...
final class SupportWireModelingNestedComponents extends ComponentHook
{
    protected static $outersByComponentId = [];

    public static function provide()
    {
        on('flush-state', fn () => self::$outersByComponentId = []);
    ...
    public function hydrate($memo)
    {
        ...
        if (! isset(self::$outersByComponentId[$memo['id']])) {
            return;
        }

        $outers = self::$outersByComponentId[$memo['id']];
