...
final class Slot implements Htmlable
{
    ...
    public function toHtml(): string
    {
        ...
        return $this->wrapWithFragmentMarkers($this->content, [
            'name' => $this->name,
            'type' => 'slot',
            'id' => $this->componentId,
    ...
    private function wrapWithFragmentMarkers($output, $metadata)
    {
    ...
    private function encodeFragmentMetadata($metadata)
    {
        $output = '';
