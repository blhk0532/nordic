...
class Highlighter
{
    ...
    {
        return mb_rtrim($this->getCodeSnippet($content, $line, 4, 4));
    }
    ...
    {
        $lineStrlen = mb_strlen((string) ((int) array_key_last($lines) + 1));
    ...
    {
        return $this->color->apply($style, mb_str_pad((string) ($i + 1), $length, ' ', STR_PAD_LEFT));
    }
}
