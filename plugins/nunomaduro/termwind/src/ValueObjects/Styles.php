...
class Styles
{
     ...
     */
    public function inheritFromStyles(self $styles): self
    {
     ...
     */
    public function bg(string $color, int $variant = 0): self
    {
     ...
     */
    public function ml(int $margin): self
    {
     ...
     */
    public function mr(int $margin): self
    {
        return $this->with(['styles' => [
            'mr' => $margin,
        ]]);
     ...
     */
    public function mb(int $margin): self
    {
        return $this->with(['styles' => [
            'mb' => $margin,
        ]]);
     ...
     */
    public function mt(int $margin): self
    {
        return $this->with(['styles' => [
            'mt' => $margin,
        ]]);
     ...
     */
    public function mx(int $margin): self
    {
        return $this->with(['styles' => [
            'ml' => $margin,
            'mr' => $margin,
     ...
     */
    public function my(int $margin): self
    {
        return $this->with(['styles' => [
            'mt' => $margin,
            'mb' => $margin,
     ...
     */
    public function m(int $margin): self
    {
     ...
     */
    public function pl(int $padding): static
    {
        return $this->with(['styles' => [
            'pl' => $padding,
        ]]);
     ...
     */
    public function pr(int $padding): static
    {
        return $this->with(['styles' => [
            'pr' => $padding,
        ]]);
     ...
     */
    public function px(int $padding): self
    {
     ...
     */
    public function pt(int $padding): static
    {
        return $this->with(['styles' => [
            'pt' => $padding,
        ]]);
     ...
     */
    public function pb(int $padding): static
    {
        return $this->with(['styles' => [
            'pb' => $padding,
        ]]);
     ...
     */
    public function py(int $padding): self
    {
     ...
     */
    public function p(int $padding): self
    {
     ...
     */
    public function spaceY(int $space): self
    {
        return $this->with(['styles' => [
            'spaceY' => $space,
        ]]);
     ...
     */
    public function spaceX(int $space): self
    {
        return $this->with(['styles' => [
            'spaceX' => $space,
        ]]);
     ...
     */
    public function borderT(int $width = 1): self
    {
     ...
     */
    public function text(string $value, int $variant = 0): self
    {
     ...
     */
    public function truncate(int $limit = 0, string $end = '…'): self
    {
        $this->textModifiers[__METHOD__] = function ($text, $styles) use ($limit, $end): string {
            ...
            return mb_rtrim(self::trimText($text, $limit).$end);
        };
     ...
     */
    public function minW(int|string $width): static
    {
        return $this->with(['styles' => [
            'minWidth' => $width,
        ]]);
     ...
     */
    public function maxW(int|string $width): static
    {
        return $this->with(['styles' => [
            'maxWidth' => $width,
        ]]);
     ...
     */
    public function justifyBetween(): self
    {
        return $this->with(['styles' => [
     ...
     */
    public function justifyAround(): self
    {
        return $this->with(['styles' => [
     ...
     */
    public function justifyEvenly(): self
    {
        return $this->with(['styles' => [
     ...
     */
    public function justifyCenter(): self
    {
        return $this->with(['styles' => [
     ...
     */
    public function contentRepeat(string $string): self
    {
     ...
     */
    public function list(string $type, int $index = 0): self
    {
    ...
    private static function trimText(string $text, int $width): string
    {
        ...
        $text = mb_rtrim(mb_strimwidth(preg_replace(self::STYLING_REGEX, '', $text) ?? '', 0, $width, '', 'UTF-8'));

        // @phpstan-ignore-next-line
        foreach ($matches[0] ?? [] as [$part, $index]) {
            $text = mb_substr($text, 0, $index).$part.mb_substr($text, $index, null);
        }
