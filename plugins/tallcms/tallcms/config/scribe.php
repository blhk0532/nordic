...
return [
    ...
    'laravel' => [
        ...
        // Gate docs behind API enabled check for parity with API routes.
        'middleware' => ['tallcms.api-enabled'],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token by POSTing to <code>/api/v1/tallcms/auth/token</code> with your email, password, device_name, and abilities. Use the returned token as: <code>Authorization: Bearer {token}</code>',
    ],
