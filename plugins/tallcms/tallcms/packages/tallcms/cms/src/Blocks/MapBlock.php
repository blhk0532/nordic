                                ...
                                Section::make('Map Provider')
                                    ->schema([
                                        ...
                                        TextInput::make('api_key')
                                            ...
                                            ->password()
                                            ->revealable()
                                            ->visible(fn (Get $get): bool => in_array($get('provider'), ['google', 'mapbox']))
                                            ->helperText('Configure API keys in Pro Settings for better security'),
                                    ]),

                                Section::make('Map Options')
                                    ->schema([
                                        TextInput::make('zoom')
                                            ->label('Zoom Level')
                                            ->numeric()
                                        ...
                                        Select::make('style')
                                            ...
                                            ->default('streets')
                                            ->visible(fn (Get $get): bool => $get('provider') !== 'openstreetmap'),
