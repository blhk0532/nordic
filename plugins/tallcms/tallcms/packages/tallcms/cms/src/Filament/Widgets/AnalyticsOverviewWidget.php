...
class AnalyticsOverviewWidget extends Widget
{
    ...
    {
        // Use core license service - check if ever licensed (not just currently valid)
        // Expired licenses still have access to features, just not updates
        $this->isLicensed = app(PluginLicenseService::class)->hasEverBeenLicensed('tallcms/pro');
