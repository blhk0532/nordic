...
use Tallcms\Pro\Http\Middleware\InjectGoogleAnalytics;
...
class TallcmsProServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Register Google Analytics middleware to inject gtag on frontend pages
        $this->app[Kernel::class]->pushMiddleware(InjectGoogleAnalytics::class);
    }
}
