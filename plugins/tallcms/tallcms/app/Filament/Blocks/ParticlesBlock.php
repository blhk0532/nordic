...
class ParticlesBlock extends RichContentCustomBlock
{
    ...
    {
        return 'A custom Particles block';
    }
    ...
    {
        return $action
            ->modalDescription('Configure the Particles block')
            ->schema([
    ...
    {
        return view('cms.blocks.particles', [
