...
class EasyFooterPlugin implements Plugin
{
    ...
    private bool $githubEnabled = false;

    private bool $borderTopEnabled = false;

    private bool $showLogo = true;

    private bool $showUrl = true;

    private bool $hiddenFromPagesEnabled = false;

    private bool $loadTimeEnabled = false;

    private ?string $loadTimePrefix = null;

    private ?string $sentence = null;

    private bool $isHtmlSentence = false;

    private string $footerPosition = 'footer';
    ...
    private bool $isFooterEnabled = true;
     ...
     */
    private function isOnHiddenPage(): bool
    {
     ...
     */
    private function calculateLoadTime(float $startTime): string
    {
