...
class ValidationService
{
     ...
     */
    private function shouldApplyNoOverlapRule(\Zap\Enums\ScheduleTypes $scheduleType, array $noOverlapConfig, array $providedRules): bool
    {
     ...
     */
    private function findCustomScheduleConflicts(\Zap\Models\Schedule $schedule): array
    {
        $conflicts = [];
     ...
     */
    private function buildConflictErrorMessage(\Zap\Models\Schedule $newSchedule, array $conflicts): string
    {
