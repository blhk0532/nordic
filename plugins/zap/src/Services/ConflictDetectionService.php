...
final class ConflictDetectionService
{
     ...
     */
    private function shouldCheckConflict(Schedule $schedule1, Schedule $schedule2): bool
    {
     ...
     */
    private function periodPairOverlaps(
     ...
     */
    private function getSchedulePeriods(Schedule $schedule): Collection
    {
     ...
     */
    private function generateRecurringPeriods(Schedule $schedule, Collection $basePeriods): Collection
    {
        ...
        while ($current->lte($endDate)) {
            ...
            if ($this->shouldCreateRecurringInstance($schedule, $current)) {
                ...
                foreach ($basePeriods as $basePeriod) {
                    $recurringPeriod = new SchedulePeriod([
     ...
     */
    private function getOtherSchedules(Schedule $schedule): Collection
    {
