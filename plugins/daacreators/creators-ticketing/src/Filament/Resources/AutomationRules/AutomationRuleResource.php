...
final class AutomationRuleResource extends Resource
{
    ...
    {
        return self::userCan('can_manage_automations');
    }
                                ...
                                ->schema([
                                    ...
                                    Select::make('conditions.form_id')
                                        ...
                                        ->options(function (callable $get) use ($deptTableName) {
                                            ...
                                            return Form::whereHas('departments', fn ($query) => $query->whereIn($deptTableName.'.id', $selectedDepartmentIds)
                                            )->pluck('name', 'id');
                                        })
                                        ->searchable()
                                        ->preload(),
        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('view_logs')
                    ...
                    ->slideOver()
                    ->modalActions([])
                    ->authorize(fn (): bool => self::userCan('can_view_automation_logs'))
