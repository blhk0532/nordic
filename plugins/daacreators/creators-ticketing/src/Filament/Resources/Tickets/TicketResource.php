...
final class TicketResource extends Resource
{
    ...
    {
        $permissions = (new self)->getUserPermissions();
            ...
            Group::make()->schema([
                Section::make(__('creators-ticketing::resources.ticket.details'))
                    ->schema([
                        ...
                        Group::make()
                            ->schema(fn (Get $get, ?Model $record): array => self::getDynamicFormFields($record, $get('department_id'), $get('form_id'), $permissions))
