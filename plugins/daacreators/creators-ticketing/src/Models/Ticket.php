        ...
        return Attribute::make(
            get: function () {
                ...
                $titleField = $form->fields->first(function ($field) {
                    return in_array(mb_strtolower($field->name), ['title', 'subject', 'issue_title', 'ticket_title']);
                });
                ...
                if ($firstTextField && isset($this->custom_fields[$firstTextField->name])) {
                    ...
                    return is_string($value) ? mb_substr(strip_tags($value), 0, 100) : 'Ticket #'.$this->ticket_uid;
                }
        ...
        return Attribute::make(
            get: function () {
                ...
                $contentField = $form->fields->first(function ($field) {
                    return in_array(mb_strtolower($field->name), ['content', 'description', 'details', 'message', 'issue_description']);
                });
