...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/adultdate/filament-fullcalendar.svg?style=flat-square)](https://packagist.org/packages/adultdate/filament-fullcalendar)
[![Total Downloads](https://img.shields.io/packagist/dt/adultdate/filament-fullcalendar.svg?style=flat-square)](https://packagist.org/packages/adultdate/filament-fullcalendar)

<p align="center">
    <img src="https://raw.githubusercontent.com/adultdate/filament-fullcalendar/3.x/art/cover.png" alt="Filament FullCalendar" style="width: 100%; max-width: 800px; border-radius: 10px" />
</p>
...
class CalendarWidget extends FullCalendarWidget
{
    ...
    public function fetchEvents(array $fetchInfo): array
    {
        ...
        // This method should return an array of event-like objects. See: https://github.com/adultdate/filament-fullcalendar/blob/3.x/#returning-events
        // You can also return an array of EventData objects. See: https://github.com/adultdate/filament-fullcalendar/blob/3.x/#the-eventdata-class
        return [];
    }
}
```
...
See the [InteractsWithEvents](https://github.com/adultdate/filament-fullcalendar/blob/3.x/src/Widgets/Concerns/InteractsWithEvents.php) for all the available event listeners.
...
-   [Saade](https://github.com/adultdate)
...
<p align="center">
    <a href="https://github.com/sponsors/adultdate">
        <img src="https://raw.githubusercontent.com/adultdate/filament-fullcalendar/3.x/art/sponsor.png" alt="Sponsor Saade" style="width: 100%; max-width: 800px;" />
    </a>
</p>
