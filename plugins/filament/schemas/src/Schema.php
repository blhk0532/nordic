...
class Schema extends ViewComponent implements HasEmbeddedView
{
     ...
     */
    public static function start(array|self|Component|Action|ActionGroup|string|Htmlable|Closure $components): static
    {
        return static::make()
     ...
     * @param  array<Component | Action | ActionGroup | string | Htmlable> | Schema | Component | Action | ActionGroup | string | Htmlable | Closure  $components
     */
    public static function end(array|self|Component|Action|ActionGroup|string|Htmlable|Closure $components): static
    {
        return static::make()
            ->components($components)
            ->alignEnd();
     ...
     * @param  array<Component | Action | ActionGroup | string | Htmlable> | Schema | Component | Action | ActionGroup | string | Htmlable | Closure  $components
     */
    public static function center(array|self|Component|Action|ActionGroup|string|Htmlable|Closure $components): static
    {
        return static::make()
            ->components($components)
            ->alignCenter();
     ...
     * @param  array<Component | Action | ActionGroup | string | Htmlable> | Schema | Component | Action | ActionGroup | string | Htmlable | Closure  $components
     */
    public static function between(array|self|Component|Action|ActionGroup|string|Htmlable|Closure $components): static
    {
        return static::make()
            ->components($components)
            ->alignBetween();
