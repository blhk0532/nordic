...
class Get
{
     ...
     * @var array<Component>
     */
    private static array $skipComponentsChildContainersWhileSearching = [];

    private bool $shouldSkipComponentsChildContainersWhileSearching = true;
    ...
    public function __invoke(string|Component $path = '', bool $isAbsolute = false): mixed
    {
        ...
        self::$skipComponentsChildContainersWhileSearching[] = $this->component;
        ...
        $component = ($this->component->getStatePath() === $path)
            ...
            : $this->component->getRootContainer()->getComponentByStatePath(
                ...
                skipComponentsChildContainersWhileSearching: $this->shouldSkipComponentsChildContainersWhileSearching ? self::$skipComponentsChildContainersWhileSearching : [],
            );
        ...
        try {
            ...
            array_pop(self::$skipComponentsChildContainersWhileSearching);
        }
    }
