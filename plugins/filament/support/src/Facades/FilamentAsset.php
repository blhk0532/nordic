...
class FilamentAsset extends Facade
{
    ...
    {
        self::resolved(function (AssetManager $assetManager) use ($assets, $package): void {
    ...
    {
        self::resolved(function (AssetManager $assetManager) use ($variables, $package): void {
    ...
    {
        self::resolved(function (AssetManager $assetManager) use ($data, $package): void {
