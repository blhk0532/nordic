...
class AssetManager
{
     ...
     */
    private array $alpineComponents = [];
     ...
     */
    private function resolveColorShadeFromPalette(array $palette, string|int $shade): string
    {
        $color = $palette[$shade];
     ...
     * @return array<Asset>
     */
    private function getAssets(array $assets, ?array $packages = null): array
    {
        if ($packages !== null) {
