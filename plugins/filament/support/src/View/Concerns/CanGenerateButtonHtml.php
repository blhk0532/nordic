    ...
    public function generateButtonHtml(
        ...
        $attributes = $attributes
            ...
            ->merge([
                ...
                'aria-label' => $isLabelSrOnly ? mb_trim(strip_tags(e($label))) : null,
                ...
                'x-bind:aria-label' => ($isLabelSrOnly && $hasFormProcessingLoadingIndicator) ? ('isProcessing ? processingMessage : '.Js::from(mb_trim(strip_tags(e($label))))) : null,
            ], escape: false)
            ->when(
