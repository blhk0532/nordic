...
class RelationshipOrderer
{
     ...
     */
    private function buildRelationshipChain(Model $baseModel, string $relationshipPath): array
    {
    ...
    private function validateRelationshipType(Relation $relationship): void
    {
     ...
     */
    private function getTargetModel(array $relationshipChain): Model
    {
    ...
    private function initializeSubquery(Model $targetModel, string $column): EloquentBuilder
    {
    ...
    private function applyFirstRelationshipConstraint(
        EloquentBuilder $subquery,
    ...
    private function applyBelongsToConstraint(
        EloquentBuilder $subquery,
    ...
    private function applyHasOneConstraint(
        EloquentBuilder $subquery,
        HasOne $relationship,
        Model $baseModel
    ): void {
    ...
    private function applyMorphOneConstraint(
        EloquentBuilder $subquery,
    ...
    private function applyBelongsToThroughConstraint(
        EloquentBuilder $subquery,
    ...
    private function applyHasOneThroughConstraint(EloquentBuilder $subquery, HasOneThrough $relationship): void
    {
    ...
    private function applyIntermediateRelationshipJoin(
        EloquentBuilder $subquery,
    ...
    private function joinBelongsToThrough(
        EloquentBuilder $subquery,
        BelongsToThrough $relationship,
        string $previousTable
    ): void {
    ...
    private function joinHasOneThrough(
        EloquentBuilder $subquery,
