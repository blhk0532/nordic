...
class OptimizeClearCommand extends Command
{
    ...
    protected $name = 'filament:optimize-clear';
    ...
    public function handle(): int
    {
        ...
        if ($this->canCachePanelComponents()) {
            $tasks->put(
                ...
                fn (): bool => $this->callSilent('filament:clear-cached-components') === self::SUCCESS,
            );
        }

        $tasks->put(
            'Clearing cached Blade icons',
            fn (): bool => $this->callSilent('icons:clear') === self::SUCCESS,
        );
