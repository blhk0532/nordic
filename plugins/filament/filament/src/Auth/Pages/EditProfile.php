...
class EditProfile extends Page
{
    ...
    public static function registerRoutes(Panel $panel): void
    {
        if (filled(self::getCluster())) {
            Route::name(self::prependClusterRouteBaseName($panel, ''))
                ->prefix(self::prependClusterSlug($panel, ''))
                ->group(fn () => self::routes($panel));
    ...
    public static function getRouteName(?Panel $panel = null): string
    {
        ...
        return $panel->generateRouteName('auth.'.self::getRelativeRouteName($panel));
    }
