...
class CreateRecord extends Page
{
    ...
    {
        self::$canCreateAnother = false;
    }

    public function getBreadcrumb(): string
    {
        return self::$breadcrumb ?? __('filament-panels::resources/pages/create-record.breadcrumb');
    }
    ...
    public function getTitle(): string|Htmlable
    {
        ...
        return __('filament-panels::resources/pages/create-record.title', [
            'label' => self::getResource()::getTitleCaseModelLabel(),
        ]);
    }
    ...
    {
        abort_unless(self::getResource()::canCreate(), 403);
    }
    ...
    {
        return self::getResource()::getParentResourceRegistration()->getRelationship($parent)->save($record);
    }
