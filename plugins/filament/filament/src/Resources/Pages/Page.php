...
abstract class Page extends BasePage
{
     ...
     */
    final public static function getNavigationItems(array $urlParameters = []): array
    {
        return [
     ...
     */
    final public static function getNavigationUrl(array $parameters = []): string
    {
     ...
     * @param  array<string, mixed>  $parameters
     */
    final public static function getUrl(array $parameters = [], bool $isAbsolute = true, ?string $panel = null, ?Model $tenant = null, bool $shouldGuessMissingParameters = false): string
    {
    ...
    final public static function getResourcePageName(): string
    {
    ...
    final public static function route(string $path): PageRegistration
    {
    ...
    final public static function getEmailVerifiedMiddleware(Panel $panel): string
    {
        return static::getResource()::getEmailVerifiedMiddleware($panel);
    }

    final public static function isEmailVerificationRequired(Panel $panel): bool
    {
        return static::getResource()::isEmailVerificationRequired($panel);
    }

    final public static function getTenantSubscribedMiddleware(Panel $panel): string
    {
     ...
     * @param  array<string, mixed>  $parameters
     */
    final public static function shouldRegisterNavigation(array $parameters = []): bool
    {
     ...
     * @return class-string
     */
    final public static function getResource(): string
    {
        return static::$resource;
    }

    final public static function getSubNavigationPosition(): SubNavigationPosition
    {
     ...
     * @param  array<string, mixed>  $parameters
     */
    final public function getResourceUrl(?string $name = null, array $parameters = [], bool $isAbsolute = true, ?string $panel = null, ?Model $tenant = null, bool $shouldGuessMissingParameters = true): string
    {
    ...
    final public function hasResourceBreadcrumbs(): bool
    {
        return true;
    }
     ...
     * @return array<string>
     */
    final public function getResourceBreadcrumbs(): array
    {
        $breadcrumbs = [];
     ...
     * @return array<string>
     */
    final public function getRenderHookScopes(): array
    {
        return [
    ...
    final public function getDefaultActionAuthorizationResponse(Action $action): ?Response
    {
        return match (true) {
    ...
    final public function getDefaultActionIndividualRecordAuthorizationResponseResolver(Action $action): ?Closure
    {
        return match (true) {
     ...
     * @return ?class-string<Model>
     */
    final public function getDefaultActionModel(Action $action): ?string
    {
        return $this->getModel();
    }

    final public function getDefaultActionModelLabel(Action $action): ?string
    {
        return $this->getModelLabel() ?? static::getResource()::getModelLabel();
    }

    final public function getDefaultActionRelationship(Action $action): ?Relation
    {
        if (
    ...
    final public function getDefaultActionUrl(Action $action): ?string
    {
     ...
     */
    final public function getModelLabel(): ?string
    {
        return null;
    }
