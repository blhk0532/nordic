...
abstract class Resource
{
    ...
    final public static function configureTable(Table $table): void
    {
        $table
     ...
     */
    final public static function getRelations(): array
    {
        return [];
    }
     ...
     */
    final public static function getWidgets(): array
    {
        return [];
    }
