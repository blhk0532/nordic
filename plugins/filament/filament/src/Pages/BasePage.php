...
abstract class BasePage extends Component implements HasActions, HasRenderHookScopes, HasSchemas
{
    ...
    final public static function stickyFormActions(bool $condition = true): void
    {
        static::$formActionsAreSticky = $condition;
    }

    final public static function alignFormActionsStart(): void
    {
        static::$formActionsAlignment = Alignment::Start;
    }

    final public static function alignFormActionsCenter(): void
    {
        static::$formActionsAlignment = Alignment::Center;
    }

    final public static function alignFormActionsEnd(): void
    {
     ...
     */
    final public static function alignFormActionsLeft(): void
    {
     ...
     */
    final public static function alignFormActionsRight(): void
    {
        static::alignFormActionsEnd();
    }

    final public static function formActionsAlignment(string|Alignment $alignment): void
    {
        static::$formActionsAlignment = $alignment;
    }

    final public static function inlineLabels(bool $condition = true): void
    {
    ...
    final public function getHeading(): string|Htmlable|null
    {
        return $this->heading ?? $this->getTitle();
    }

    final public function getSubheading(): string|Htmlable|null
    {
    ...
    final public function getMaxContentWidth(): Width|string|null
    {
     ...
     * @return array<mixed>
     */
    final public function getExtraBodyAttributes(): array
    {
        return $this->extraBodyAttributes;
    }

    final public function getFormActionsAlignment(): string|Alignment
    {
        return static::$formActionsAlignment;
    }

    final public function areFormActionsSticky(): bool
    {
        return static::$formActionsAreSticky;
    }

    final public function hasInlineLabels(): bool
    {
