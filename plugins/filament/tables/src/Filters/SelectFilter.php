...
class SelectFilter extends BaseFilter
{
    ...
    protected function setUp(): void
    {
        ...
        $this->indicateUsing(static function (SelectFilter $filter, array $state): array {
            if ($filter->isMultiple()) {
                ...
                if ($filter->queriesRelationships()) {
                    ...
                    if (
                        ...
                        in_array(self::EMPTY_RELATIONSHIP_OPTION_KEY, $state['values'])
                    ) {
            ...
            if ($filter->queriesRelationships()) {
                if (
                    $filter->hasEmptyRelationshipOption() &&
                    ($state['value'] === self::EMPTY_RELATIONSHIP_OPTION_KEY)
                ) {
    ...
    public function apply(Builder $query, array $data = []): Builder
    {
        ...
        if (
            ...
            in_array(self::EMPTY_RELATIONSHIP_OPTION_KEY, Arr::wrap($values))
        ) {
