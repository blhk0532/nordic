...
class Notification extends ViewComponent implements Arrayable, HasEmbeddedView
{
    ...
    {
        $static = app(self::class, ['id' => $id ?? Str::orderedUuid()]);
        $static->configure();
    ...
    public static function assertNotified(self|string|null $notification = null): void
    {
    ...
    public static function assertNotNotified(self|string|null $notification = null): void
    {
        $notificationsLivewireComponent = new Notifications;
        $notificationsLivewireComponent->mount();
        $notifications = $notificationsLivewireComponent->notifications;
        ...
        if ($expectedNotification instanceof self) {
            Assert::assertNotSame(
