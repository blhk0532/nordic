...
abstract class Importer
{
    ...
    final public static function getCompletedNotificationTitle(Import $import): string
    {
        return __('filament-actions::import.notifications.completed.title');
    }

    final public function remapData(): void
    {
        $data = $this->data;
     ...
     */
    final public function checkColumnMappingRequirementsForNewRecords(): void
    {
        foreach ($this->getCachedColumns() as $column) {
            $columnName = $column->getName();
    ...
    final public function castData(): void
    {
        foreach ($this->getCachedColumns() as $column) {
            $columnName = $column->getName();
    ...
    final public function resolveRecord(): ?Model
    {
     ...
     * @throws ValidationException
     */
    final public function validateData(): void
    {
        Validator::validate(
            $this->data,
     ...
     */
    final public function getValidationMessages(): array
    {
        return [];
    }
     ...
     * @return array<string, string>
     */
    final public function getValidationAttributes(): array
    {
        $attributes = [];
    ...
    final public function saveRecord(): void
    {
        $this->record->save();
    ...
    final public function getImport(): Import
    {
        return $this->import;
    }
