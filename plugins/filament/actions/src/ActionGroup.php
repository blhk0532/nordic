...
class ActionGroup extends ViewComponent implements Arrayable, HasEmbeddedView
{
    ...
    protected function setUp(): void
    {
        ...
        $this->defaultTriggerView(self::ICON_BUTTON_VIEW);
    }
    ...
    {
        $static = app(self::class, ['actions' => $actions]);
        $static->configure();
    ...
    public function toEmbeddedHtml(): string
    {
        ...
        foreach ($this->getActions() as $action) {
            ...
            if ($action instanceof self && (! $action->hasDropdown())) {
    ...
    public function getTriggerView(): string
    {
        ...
        throw new LogicException('Class ['.static::class.'] extends ['.self::class.'] but does not have a [$triggerView] property defined.');
    }
