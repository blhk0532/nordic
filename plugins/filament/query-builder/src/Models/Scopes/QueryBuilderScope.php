...
class QueryBuilderScope
{
     ...
     */
    public function __construct(private array $rules, private array $constraints)
    {
    ...
    {
        return app(self::class, ['rules' => $rules, 'constraints' => $constraints]);
    }
     ...
     */
    private function tapOperatorFromRule(array $rule, Closure $callback): void
    {
