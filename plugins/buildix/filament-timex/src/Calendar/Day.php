...
class Day extends Component
{
    ...
    public function mount()
    {
        ...
        $this->isCurrentDay = Carbon::createFromTimestamp($this->timestamp)->isCurrentDay();
        $this->isCurrentMonthDay = Carbon::createFromTimestamp($this->timestamp)->isCurrentMonth();
        $this->isWeekend = Carbon::createFromTimestamp($this->timestamp)->isWeekend();
        $this->firstDayOfMonth = Carbon::createFromTimestamp($this->timestamp)->firstOfMonth()->timestamp;
