...
final class Utils
{
    ...
    {
        return (string) (config('filament-tree.default_children_key', 'children'));
    }
        ...
        ?string $childrenKeyName = null): array
    {
        ...
        $parentKeyName = $parentKeyName ?: self::parentColumnName();
        $childrenKeyName = $childrenKeyName ?: self::defaultChildrenKeyName();
            ...
            if (
                ...
                foreach ($nodeGroup as $node) {
                    ...
                    $branch[] = array_merge($node, [
                        // children
                        $childrenKeyName => self::buildNestedArray(
                            nodes: $nodes,
