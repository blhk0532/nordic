...
final class Log
{
    ...
    private static function parseLogEntry(array $lines, string $file): ?array
    {
        ...
        return [
            'date' => array_key_exists('date', $matches) ? mb_trim($matches['date']) : '',
            'env' => array_key_exists('env', $matches) ? mb_trim($matches['env']) : '',
    ...
    private static function splitMessageAndContext(string $raw): array
    {
        ...
        if (preg_match($pattern, $raw, $matches)) {
            ...
            if (json_last_error() !== JSON_ERROR_NONE || ! is_array($decoded)) {
                return [mb_trim($matches['message']), null];
            }
        ...
        return app(Pipeline::class)
            ...
            ->through([
                ...
                function (array $parts, $next) {
                    ...
                    return $next(isset($tracePart) ? mb_trim($tracePart) : null);
                },
