...
class RatsitScraper:
    ...
    def __init__(self, api_url: Optional[str] = None, api_token: Optional[str] = None):
        ...
        Args:
            api_url: Base URL for the Laravel API (e.g., https://app.nordicdigitalthailand.com)
            api_token: Sanctum authentication token (optional)
        """
        self.api_url = api_url or os.getenv('LARAVEL_API_URL', 'https://app.nordicdigitalthailand.com')
